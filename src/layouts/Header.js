      ...
      >
        ...
        >
          <ul className="flex items-center space-x-3">
            ...
            <li>
              <button
                className="rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-[#1e3a5f] dark:focus:ring-gray-700"
                onClick={toggleMode}
              >
                {darkModeEnabled ? (

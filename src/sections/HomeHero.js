...
export default function HomeHero() {
  ...
  return (
    <section className="relative w-full max-w-none flex max-h-screen min-h-screen flex-col items-center justify-center overflow-hidden px-0 pt-16">
      ...
      <p className="relative z-10 mb-8 pb-2 leading-[1.15] bg-linear-to-r from-[#f3cd50] via-[#73f09c] to-[#75e4a0] bg-clip-text text-center font-lato text-5xl font-black tracking-tight text-transparent sm:text-6xl md:text-7xl lg:text-8xl">
        John Ughiovhe
      </p>
